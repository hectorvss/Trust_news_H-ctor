...
const AccessLimitModal = ({ isOpen, onClose, currentPlan = 'FREE', mode = 'LIMIT' }) => {
  ...
  const handleExitClick = () => {
    if (mode === 'AUTH' && !showExitConfirm) {
      setShowExitConfirm(true);
    } else {
      onClose(true); // Actual exit
    }
  };
      ...
      >
        ...
        {!showExitConfirm ? (
          ...
          <div style={{ animation: 'fadeIn 0.4s ease' }}>
            ...
            <h2 style={{ fontSize: '38px', fontWeight: 800, letterSpacing: '-2px', marginBottom: '24px', lineHeight: '0.95' }}>
              Vaya. Parece que te sobran excusas y te falta curiosidad.
            </h2>
            
            <p style={{ fontSize: '16px', lineHeight: '1.5', fontWeight: 500, color: '#444', marginBottom: '40px' }}>
              Crear una cuenta en TNE lleva exactamente <strong style={{color: 'black'}}>12 segundos</strong>. Literalmente menos de lo que acabas de tardar en leer este texto. <br/><br/>
              ¿De verdad prefieres seguir viendo el mundo a través de un muro por ahorrarte tres clics?
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '20px' }}>
              ...
              >
                SÍ, PREFIERO SEGUIR DESINFORMADO ×
              </button>
            </div>
          </div>
        )}
