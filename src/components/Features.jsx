...
const FEATURE_GROUPS = [
  ...
  {
    id: 'api',
    title: 'API & MCP para desarrolladores',
    tag: 'DESARROLLADORES',
    items: [
      ['API key con tu cuenta', 'Crea claves desde Mi cuenta → API. El plan y los límites se ajustan solos a tu suscripción.', 'ESTÁNDAR'],
      ['Conectores MCP (Claude, Cursor…)', 'Añade Trust News como conector y usa las noticias como herramientas nativas de tu IA.', 'ESTÁNDAR'],
      ['REST + OpenAPI', 'Endpoints REST documentados para ChatGPT Actions, n8n, Make, Zapier o tu propia app.', 'ESTÁNDAR'],
      ['Herramientas básicas', 'search_news, list_stories, get_story, list_sources y rate_source (sesgo/factualidad/trust score).', 'ESTÁNDAR'],
      ['Comparar cobertura entre medios', 'compare_coverage: cómo encuadra cada medio la misma noticia (ángulo, tono, qué enfatiza u omite).', 'PREMIUM'],
      ['Análisis completo y contexto para IA', 'full_analysis, get_source_piece y get_story_context: cuerpo, verificación, cifras y paquete listo para agentes.', 'PREMIUM'],
      ['Puntos ciegos y tendencias', 'list_blindspots, blindspot_narrative, coverage_trends y trending_topics vía API/MCP.', 'PREMIUM'],
      ['Analizar sesgo de artículos externos', 'analyze_bias: pega un texto o una URL y obtén su inclinación, encuadre y términos cargados.', 'PREMIUM'],
      ['Resumen diario y relacionadas', 'daily_brief y related_stories para automatizar briefings y descubrimiento.', 'PREMIUM'],
      ['Webhooks y límite alto', 'Avisos automáticos (puntos ciegos, temas) y hasta 100.000 peticiones/día por clave.', 'ELITE'],
    ],
  },
];
