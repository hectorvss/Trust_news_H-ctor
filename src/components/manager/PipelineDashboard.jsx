...
export default function PipelineDashboard() {
  ...
  const cards = [
    ...
    { label: 'Toddy 24h', value: s.toddyResponses24h ?? 0, sub: `${s.toddyFreeUsed24h ?? 0} free usados` },
    { label: 'Creditos Toddy', value: s.toddyCredits24h ?? 0, sub: `${s.toddyTokens24h ?? 0} tokens` },
    { label: 'Toddy baja confianza', value: s.toddyLowConfidence24h ?? 0, sub: Object.entries(s.toddyDepthDistribution24h || {}).map(([k, v]) => `${k}:${v}`).join(' Â· ') || 'sin consultas' },
