export const mockStories = [
  {
    ...
    analyticalSnippet: "La cobertura nacional se divide entre el impacto regulatorio (45%) y el riesgo de mercado (25%). Se detecta un fuerte interés en el segmento de arrendatarios jóvenes que ven en la ley su única vía de emancipación.",
    detailStats: [
      { k: 'Límite de subida', v: '3.0% anual' },
      { k: 'Contratos afectados', v: '2,400,000' },
      { k: 'Vigencia inicial', v: '31 DIC 2024' },
      { k: 'Ahorro promedio', v: '142€/mes' }
    ],
    sources: ['El País', 'ABC', 'El Mundo', 'RTVE', 'elDiario.es', 'La Vanguardia'],
  ...
  },
  {
    ...
    analyticalSnippet: "Consenso institucional sobre el crecimiento (60%), mientras que el debate periférico (40%) se centra en la calidad del empleo y el riesgo del déficit estructural ante la vuelta de las reglas fiscales europeas.",
    detailStats: [
      { k: 'PIB Proyectado', v: '2.4%' },
      { k: 'Diferencial UE', v: '+1.6 pts' },
      { k: 'Deuda Pública', v: '107.7%' },
      { k: 'Consumo Interno', v: '+3.1%' }
    ],
    sources: ['Expansión', 'Cinco Días', 'El Economista', 'Reuters', 'Bloomberg', 'EFE'],
  ...
  },
  {
    ...
    analyticalSnippet: "Divergencia máxima (90% en polos) sobre el equilibrio entre seguridad y libertad. La cobertura se fractura entre la recuperación de derechos civiles (40%) y la supuesta desprotección policial (50%).",
    detailStats: [
      { k: 'Artículos reformados', v: '36' },
      { k: 'Sanciones 2023', v: '184,000' },
      { k: 'Votos a favor', v: '176 (est.)' },
      { k: 'Revisiones TC', v: '4' }
    ],
    sources: ['La Razón', 'Público', 'Infolibre', 'Europa Press', 'The objective', 'EFE'],
  ...
  },
  {
    ...
    analyticalSnippet: "Fuerte sesgo de impacto social (55%) centrado en la precariedad asistencial, con una contraparte institucional (25%) que apela a la falta de profesionales como problema demográfico global, no solo local.",
    detailStats: [
      { k: 'Pacientes/Día', v: '42-50' },
      { k: 'Déficit Médicos', v: '4,500' },
      { k: 'Presupuesto AP', v: '14.2% del total' },
      { k: 'Días de espera', v: '9.4 (media)' }
    ],
    sources: ['Redacción Médica', 'ConSalud', 'El Correo', 'La Voz de Galicia', 'RTVE', 'Cadena SER'],
  ...
  },
  {
    ...
    analyticalSnippet: "Alta convergencia técnica (70%) sobre la viabilidad estratégica, con focos de incertidumbre hídrica extrema (15%) en el interior peninsular y dudas sobre la rentabilidad a largo plazo sin subsidios.",
    detailStats: [
      { k: 'Inversión Total', v: '5,000M€' },
      { k: 'Empleos Directos', v: '800' },
      { k: 'Capacidad H2', v: '2.5GW' },
      { k: 'Meta Export.', v: '2Mt/año' }
    ],
    sources: ['Energía Diario', 'PV Magazine', 'El Periódico de la Energía', 'Financial Times', 'Handelsblatt'],
