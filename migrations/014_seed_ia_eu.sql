...
-- Noticia de Alta Fidelidad con Desarrollo Editorial Extendido v7.0
-- USANDO DOLLAR QUOTING PARA SEGURIDAD JSON
-- ==========================================================
...
INSERT INTO public.stories (
    ...
    -- ORIGEN
    $$ ["Parlamento Europeo", "Comisión Europea (DG CONNECT)", "OpenAI Compliance Dept.", "Mistral AI", "Stanford HAI"] $$,
    -- MEDIOS ANALIZADOS
    $$ ["REUTERS", "POLITICO", "TECHCRUNCH", "EL PAÍS", "LE MONDE", "WIRED"] $$,
    -- DOCUMENTOS
    $$ [{"name": "DIRECTIVA_IA_TEXTO_FINAL.PDF", "size": "12.4MB"}, {"name": "IA_STAKEHOLDER_REACTIONS.PDF", "size": "4.2MB"}] $$,
    -- FACT CHECK
    ...
    -- IMPACTO SISTÉMICO
    $$ ["Creación del Mercado Único de IA: una sola regla para 27 países, evitando la fragmentación legal.", "Fortalecimiento de la soberanía digital europea frente a infraestructuras en la nube extranjeras.", "Posible encarecimiento de los servicios digitales en la UE debido a los costes de cumplimiento."] $$,
    
    -- ARTÍCULOS DETALLADOS (CONTENIDO MASIVO USANDO DOLLAR QUOTING)
    $$ [
        {
            "id": "ia-art-wired",
            "source": "WIRED",
